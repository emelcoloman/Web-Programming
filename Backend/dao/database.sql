...
CREATE TABLE `users` (
  ...
  `permissions` text COMMENT 'JSON encoded permissions list',
  PRIMARY KEY (`id`),
...
INSERT INTO `users` VALUES (1,'Admin User','123456','admin@example.com','admin','[\"manage_users\",\"view_reports\"]'),(2,'Regular User','123456','user@example.com','user',NULL);
...
-- Dump completed on 2025-06-09  1:50:56
